...
- You need to have an application registered in Asgardeo. If you don't, see the instructions on <a :href="$withBase('/guides/applications/web-app/oidc/register-app')">registering an OIDC application</a>.
