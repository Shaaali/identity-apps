...
You can add Facebook login to your applications using Asgardeo and enable users to log into applications with their Facebook account. To provides this capability, Asgardeo uses standard [OAuth2.0 protocol](https://datatracker.ietf.org/doc/html/rfc6749#section-1.3) underneath.  
