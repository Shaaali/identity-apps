...
To get started, you need to have an application registered in Asgardeo. If you don't have an app registered, <a :href="$withBase('/guides/applications/register-oidc-web-app/')">register an application</a> in Asgardeo to enable OpenID Connect enterprise login.
