...
To self register:
1. Go to the login page via the <a :href="$withBase('/guides/organization/self-service/customer/my-account/#access-my-account-portal')">My Account Portal</a> or a business application.
