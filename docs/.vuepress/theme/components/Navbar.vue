<template>
  <div class="navbar">
    ...
    >
      ...
      <Button class="header-signup-btn" buttonType="default-outlined" buttonText="Sign Up for Asgardeo" openInNewTab="true" externalLink="https://asgardeo.io/signup?utm_source=asgardeo_docs"/>
    </div>
  </div>
</template>
