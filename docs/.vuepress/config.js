                ...
                ['create-asgardeo-account.md', 'Create your Account'],
                {
                    ...
                    children:[
                        ...
                        },      
                        {
                            ...
                            prefix: 'integrate-your-own-app/',
                            path: 'integrate-your-own-app/',
                            sidebarDepth: 2,
                            children: [
                                {
                                    title: 'SPAs',
                        ...
                        children: [
                            ...
                            ['web-app/add-login-to-web-app.md', 'Add login to a web app'],
                            {
                                ...
                                children: [
                                    ...
                                    ['implement-auth-code.md', 'Implement login using Auth Code flow'],
                                    ['implement-auth-code-with-pkce.md', 'Implement login using Auth Code flow and PKCE'],
                                    ['validate-id-tokens.md', 'Validate ID tokens'],
                                    ['request-user-info.md', 'Request user information'],
                                    ['token-validation-resource-server.md', 'Validate tokens (resource servers)'],
