...
4. Select **OIDC Standard-Based Application** as the app type and the **Management Application** checkbox. Learn more about <a :href="$withBase('/references/app-settings/oids-settings-for-app')">OIDC configurations</a>.
